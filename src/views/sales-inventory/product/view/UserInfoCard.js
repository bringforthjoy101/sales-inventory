          ...
          <Col xl='6' lg='12' className='d-flex flex-column justify-content-between border-container-lg'>
            ...
            <div className='user-avatar-section'>
              ...
              <div className='d-flex align-items-center mr-2 mt-1'>
                ...
                <div className='ml-1'>
                  <h6 className='mb-0'>{(Number(selectedProduct.price) - (Number(selectedProduct.costPrice))).toLocaleString('en-NG', { style: 'currency', currency: 'NGN' })}</h6>
                </div>
              </div>
              <div className='d-flex align-items-center mr-2 mt-1'>
                <div className='color-box'>
                  <span>Product Store Qty: </span>
                </div>
                <div className='ml-1'>
                  <h6 className='mb-0'>{selectedProduct.storeQty}</h6>
                </div>
              </div>
              <div className='d-flex align-items-center mr-2 mt-1'>
                <div className='color-box'>
                  <span>Product For Sale Qty: </span>
                </div>
                <div className='ml-1'>
