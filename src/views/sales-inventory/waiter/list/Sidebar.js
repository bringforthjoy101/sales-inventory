...
const SidebarNewUsers = ({ open, toggleSidebar }) => {
	...
	const onSubmit = async (event, errors) => {
		...
		if (errors && !errors.length) {
			...
			try {
				const response = await apiRequest({ url: '/waiters/create', method: 'POST', body }, dispatch)
	...
	return (
		<Sidebar size="lg" open={open} title="New Waiter" headerClassName="mb-1" contentClassName="pt-0" toggleSidebar={toggleSidebar}>
