...
import { getAllData, getWaiterDetails } from '../store/action'
...
export const AddFunds = ({ waiterDetails }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
        <ModalHeader toggle={() => setFormModal(!formModal)}>Credit {waiterDetails.firstName}'s Wallet</ModalHeader>
        <Formik
          initialValues={{
            amount: '',
            narration: '',
            type: 'credit',
            customerId: waiterDetails.id
          }}
          ...
          onSubmit={async (values, { setSubmitting }) => {
            ...
            await dispatch(getWaiterDetails(waiterDetails.id))
          }}
        >
...
export const DeductFunds = ({ waiterDetails }) => {
  const dispatch = useDispatch()
  const [formModal, setFormModal] = useState(false)
  ...
  return (
    <div>
      ...
      <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
        <ModalHeader toggle={() => setFormModal(!formModal)}>Debit {waiterDetails.firstName}'s Wallet</ModalHeader>
        <Formik
          initialValues={{
            amount: '',
            narration: '',
