			...
			<div className="row ml-1" style={{ width: '302px' }}>
				...
				<div className="d-flex justify-content-between flex-column pb-2">
					...
					<div className="mt-md-0 mt-2">
						...
						{/* <div className="invoice-date-wrapper mb-50">
							<p className="invoice-date-title">Waiter:</p>
							<p className="font-weight-bold">{selectedOrder?.waiter.fullName} - {selectedOrder?.waiter.phone}</p>
						</div> */}
				...
				<Row className="invoice-sales-total-wrapper mt-3">
					...
					<Col className="mt-md-0 mt-3" md="12">
						<p className="mb-0">
							<span className="font-weight-bold">Attendant:</span> <span className="ml-75">{selectedOrder?.waiter.fullName}</span>
						</p>
					</Col>
				</Row>
